        ...
        <div class="col-md-8 col-sm-8 marb20">
          <div class="contact-info">
            ...
            <form method="post" class="contactForm">
			  ...
			  <div class="form-group">
                <input type="text" class="form-control br-radius-zero" name="Illness/Prescription" placeholder="Illness/Prescription" required/>
                <div class="validation"></div>
              </div>
			  <div class="form-group">
...
$sql="insert into appointment values('$patient_id','$name','$age','$gender','$occupation','$contact_number','$address','$date')";
